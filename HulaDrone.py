...
class HulaDrone:
    ...
    def square_aim_flight(self, side_length: float, unit: str, aim_time: float, completion_callback = None, step_callback = None):
        ...
        def post_step_callback(aim_time: float, leave_rotation_degree: int, preferred_tag_id=None):
    ...
    def execute_fly_plan(self, fly_plan: List[FlightPlanPoint], completion_callback=None, step_callback=None, post_step_callback=None):
        ...
        def on_target_reached(current_position):
            ...
            controller.set_global_target_location(next_point.target_location)
        ...
        try:
            ...
            controller.set_global_target_location(first_point.target_location)
            self.status["message"] = self._format_fly_plan_point_status(
                "前往",
                1,
                len(fly_plan),
